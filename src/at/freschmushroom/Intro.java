...
public class Intro
{
	...
	public static DisplayMode getLargest() throws LWJGLException
	{
		...
		Out.line(Display.getDisplayMode().getWidth() + "x" + Display.getDisplayMode().getHeight() + "x" + Display.getDisplayMode().getFrequency());
		Out.line(modes[index].getWidth() + "x" + modes[index].getHeight() + "x" + modes[index].getFrequency());
	 ...
	 * 
	 * @throws LWJGLException
	 *             if showing the Intro in a window is Problematic
	 */
	 ...
	 * 
	 * @param parent
	 *            the canvas the Intro should be shown on
	 * @throws LWJGLException
	 *             if you shall not show your Intro in this Canvas
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if some font files could not be found
	 */
