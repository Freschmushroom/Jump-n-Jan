...
public class XMLFile
{
	 ...
	 * 
	 * @param f
	 *            the File this XMLFile is based on
	 */
	...
	/**
	 * Constructs a new XMLFile based on the File specified by the given path
	 * and name
	 * 
	 * @param path
	 *            the path to the file
	 * @param name
	 *            the name of the file (without .xml)
	 */
	 ...
	 * 
	 * @return the lines of the file stored in the Runtime Efficient IO Access
	 *         Buffer
	 */
	 ...
	 * 
	 * @param declaration
	 *            the new declaration of the Document
	 */
