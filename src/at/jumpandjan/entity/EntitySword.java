 ...
 * 
 */
public class EntitySword extends at.jumpandjan.entity.Entity
{
	/**
	 * @see {@link #getDamage()}
	...
	public EntitySword(double x, double y, double width, double height, Level level, int damage, EntityPlayer parent)
	{
	...
	{
		if (withObject instanceof Entity && !(withObject instanceof EntityJannyBunny))
		{
