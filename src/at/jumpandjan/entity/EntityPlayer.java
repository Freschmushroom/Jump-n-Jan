...
public class EntityPlayer extends Entity
{
	 ...
	 */
	public EntityPlayer(double x, double y, double width, double height, Level level)
	{
	...
	{
		return super.checkCollisionWith(o) && !(o instanceof EntityInk || o instanceof EntityJannyBunny || o instanceof EntityStartFlag);
	}
	...
	public void render()
	{
		...
		TextureManager.instance.bindTexture(TextureManager.instance.getTexture("/Janny_Knight.png"));
		glColor3f(1, 1, 1);
		float f = 1 / 32f;
		float f1 = 1 / 256f;
		glBegin(GL_QUADS);
		...
		glColor3f(1, (maxPoints - points) / maxPoints, (maxPoints - points) / maxPoints);
	...
	/**
	 * Adds a point. Convenience method
	 */
