...
public class GuiLevelChooser extends Gui
{
	...
	public GuiLevelChooser(JumpAndJan game)
	{
		this.game = game;
	}
	...
	private void initLevels()
	{
		...
		for (File f : levels)
		{
			...
			try
			{
				...
				Level level = new Level(game, LevelBuilder.load(f.getAbsolutePath()));
				if (user.isUnlocked(level.getName()))
				{
					CompButton button = new CompButton(this, 100, y, 200, 40, level.getName());
