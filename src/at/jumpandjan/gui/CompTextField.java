...
public class CompTextField extends Component {
	...
	public CompTextField(int x, int y, int width, int height, String text) {
	...
	public void drawComponent() {
		...
		font.drawString(textX, 480 - font.getHeight(text) - textY,
				text.substring(0, caret) + "\\u" + text.substring(caret), 1, 1,
				align);
	...
	public CompTextField setTextAlignment(int align) {
		this.align = align;
		return this;
	}
