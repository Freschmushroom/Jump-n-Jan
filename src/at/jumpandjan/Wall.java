...
public class Wall extends Object
{
	...
	public void render()
	{
		...
		glBegin(GL_QUADS);
		glTexCoord2f(0, 1);
		glVertex2d(this.bounds.x, this.bounds.y + 32);
		glTexCoord2f(1, 1);
		glVertex2d(this.bounds.x, this.bounds.y + this.bounds.height - 32);
		glTexCoord2f(1, 0);
		glVertex2d(this.bounds.x + this.bounds.width, this.bounds.y + this.bounds.height - 32);
		glTexCoord2f(0, 0);
		glVertex2d(this.bounds.x + this.bounds.width, this.bounds.y + 32);
		glEnd();
